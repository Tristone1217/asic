...
extern "C" {
#endif
void  hsM_0_0__simv_simple_fsm_daidir (UB  * pcode, scalar  val);
void  hsM_0_1__simv_simple_fsm_daidir (UB  * pcode, scalar  val, U  I643, scalar  * I1111, U  did);
void  hsM_0_2__simv_simple_fsm_daidir (UB  * pcode);
void  hsM_1_0__simv_simple_fsm_daidir (UB  * pcode, scalar  val);
void  hsM_1_1__simv_simple_fsm_daidir (UB  * pcode, scalar  val, U  I643, scalar  * I1111, U  did);
void  hsM_1_2__simv_simple_fsm_daidir (UB  * pcode);
